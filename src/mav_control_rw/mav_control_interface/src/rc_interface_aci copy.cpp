...
//     last_data_.left_up_down = (msg->axes[1]-0.5)/2.0; // thrust 
...
//     //  ROS_INFO("joy input recived");
//     // last_data_.right_up_down = msg->axes[0];  4 
//     // last_data_.right_side = -msg->axes[1];    -3
//     // last_data_.left_up_down = msg->axes[2];  --> 1
//     // last_data_.left_side = -msg->axes[3];  -0
